...
void setup() {
  ...
  // Attach the servo control to pin 9
  myServo.attach(9);
}
...
// Action for red color: Move forward and control the servo
void handleRed() {
  Serial.println("Dominant Color: Red - Moving forward.");
  goForward();
  moveServo(); // Move the servo after turning
}

// Action for green color: Turn right and control the servo
void handleGreen() {
...
// Action for blue color: Turn left and control the servo
void handleBlue() {
...
void turnLeft() {
  ...
  delay(7000); // Time for turning left
  motor1.run(FORWARD);
    motor2.run(FORWARD);
    motor3.run(FORWARD);
    motor4.run(FORWARD);
...
void turnRight() {
  ...
  delay(7000); // Time for turning right
    motor1.run(FORWARD);
    motor2.run(FORWARD);
    motor3.run(FORWARD);
    motor4.run(FORWARD);
...
void moveServo() {
  ...
  myServo.write(45);   // Move the servo to 75 degrees
